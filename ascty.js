...
'_glue',
{
typedefinitions : function (_td
,) {
_ruleEnter ("typedefinitions");

var td = _td._glue ().join ('');
var _result = `${td}`;
...
foreigntype : function (_id,_eq,_ws1
,_k,_ws2
,) {
_ruleEnter ("foreigntype");

var id = _id._glue ();var eq = _eq._glue ();var ws1 = _ws1._glue ().join ('');var k = _k._glue ();var ws2 = _ws2._glue ().join ('');
var _result = `${id}${eq}${ws1}${k}${ws2}`;
_ruleExit ("foreigntype");
return _result;
},
typeequivalence : function (_id,_eq,_ws1
,_b,_ws2
,) {
_ruleEnter ("typeequivalence");

var id = _id._glue ();var eq = _eq._glue ();var ws1 = _ws1._glue ().join ('');var b = _b._glue ();var ws2 = _ws2._glue ().join ('');
var _result = `${id}${eq}${ws1}${b}${ws2}`;
_ruleExit ("typeequivalence");
return _result;
},
...
var _result = `${id}${lb}${ws1}${body}${rb}${ws2}`;
...
var _result = `${id1}${k}${ws}${lb}${id2}${rb}`;
_ruleExit ("collectionDefinition");
return _result;
},
fieldsDefinition : function (_field
,) {
_ruleEnter ("fieldsDefinition");

var field = _field._glue ().join ('');
var _result = `${field}`;
_ruleExit ("fieldsDefinition");
return _result;
},
...
var _result = `${id1}${k}${ws}${id2}${lb}${id3}${rb}`;
_ruleExit ("listDefinition");
return _result;
},
includeDefinition : function (_k,_ws1
,_id,_ws2
,) {
_ruleEnter ("includeDefinition");

var k = _k._glue ();var ws1 = _ws1._glue ().join ('');var id = _id._glue ();var ws2 = _ws2._glue ().join ('');
var _result = `${k}${ws1}${id}${ws2}`;
_ruleExit ("includeDefinition");
return _result;
},
elsewhere : function (_k,_ws
,) {
_ruleEnter ("elsewhere");
